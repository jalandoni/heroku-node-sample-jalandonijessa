    ...
    $('#disconnect-btn').click (function () {
      ...
      $('.join').show();
        ...
        $('form').submit(function(e){
          e.preventDefault();
          if ($('#m').val() != "" && $('#form').val() != "") {
          $('.container').append("<div class='Area'><div class='text R textR'>"
          +$('#form29').val()+" : "+$('#m').val()+"</div></div>");
        ...
        socket.on('chat message', function(msg){
          $('#typing-area').hide();
          if ($('#form29').val() != "") {
            $('.container').append("<div class='Area'><div class='text L textL'>"+msg+"</div></div>");
        ...
        $("#submit-btn").click (function(e) {
          ...
          socket.on('username', function(msg) {
            if (msg != "") {
              $('.container').append("<div class='Area'><div class='text L textL'>"+msg+" has joined.</div></div>");
